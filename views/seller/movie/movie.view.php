...
<div class="hidden opacity-0 transition-opacity duration-150 ease-linear data-[te-tab-active]:block" id="tab-allMovie" role="tabpanel" aria-labelledby="tabs-profile-tab03">
