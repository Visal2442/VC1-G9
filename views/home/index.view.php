 ...
 <div id="default-carousel" class="relative" data-carousel="static">
    <div class="overflow-hidden flex relative rounded-lg mx-20 " style="height:119vh;">
                    ...
                    <div class="flex flex-col justify-center">
                      <div class="group relative items-center justify-center overflow-hidden cursor-pointer hover:shadow-xl hover:shadow-black/30 transition-shadow">
                            <div class="w-52 h-auto">
                                <img src="https://www.majorcineplex.com.kh/load_file/movie/file_20230202120247.jpg" alt="" class="h-full w-full object-cover transition-all duration-500">
                            </div>
                            ...
                            <div class=" absolute inset-0 flex flex-col items-center justify-center text-center translate-y-[100%] group-hover:translate-y-0 transition-all duration-500">
                                <h1 class=" font-bold text-white mb-3">AVfdsaffd sfsdfdfdsfddsafTAR</h1>
                                <div class="flex text-white m-1">
                                    ...
                                    <p class="ml-3">Shooting/action</p>
                                </div>
                                <div class="flex text-white mr-14 m-1">
                                    <svg class="w-7 h-7" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                        ...
                        <div class=" text-center">
                            <h1 class="text-xl text-white" >AVTAR</h1>
            ...
            <div class="flex absolute gap-10 top-0 mt-5  mb-80 left-1/2 z-30 space-x-3 -translate-x-1/2">
                <button type="button" class="p-1 rounded" aria-current="false" data-carousel-slide-to="0">All Shows</button>
