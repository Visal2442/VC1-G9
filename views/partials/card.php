<ul class="nav nav-tabs flex flex-row justify-center md:flex-row flex-wrap list-none border-b-0 pl-0 mb-4 mt-5 ml-10 gap-10" id="tabs-tab">
    <li class="nav-item">
        <a href="" class="link block text-sm font-bold text-white uppercase focus:text-yellow-400 focus:border-yellow-400 focus:border-b-2 auto leading-tight px-6 py-3 my-2 hover:border-transparent hover:bg-gray-100" data-bs-toggle="pill" data-bs-target="#all-genres" autofocus>All Genres</a>
    </li>
    <li class="nav-item">
        <a href="" class="link block text-sm font-bold text-white uppercase focus:text-yellow-400 focus:border-yellow-400 focus:border-b-2 leading-tight px-6 py-3 my-2 hover:border-transparent hover:bg-gray-100" data-bs-toggle="pill" data-bs-target="#actions">Action</a>
    </li>
    <li class="nav-item">
        <a href="#horrors" class="link block text-sm font-bold text-white uppercase focus:text-yellow-400 focus:border-yellow-400 focus:border-b-2 leading-tight px-6 py-3 my-2 hover:border-transparent hover:bg-gray-100" data-bs-toggle="pill" data-bs-target="#horrors">Horror</a>
    </li>
</ul>
<div class="tab-content">
    <div class="tab-pane fade show active" id="all-genres">
        <!-- All Genres  -->
    ...
    <div class="tab-pane fade" id="horrors">
        <!-- Horrors  -->
        <div class="grid grid-cols-2 md:gird-cols-3 lg:grid-cols-6 gap-4 p-6">
            <?php foreach ($shows as $show) :
