...
function addMovie(string $movie_name, string $genre, string $subtitle, string $description,
                string $release_date, string $duration, string $image, string $trailer): bool
{
    global $connection;
    $statement = $connection->prepare('insert into movies(movie_name, genre, subtitle, 
    description, release_date, duration, image, trailer ) values(:movie_name, :genre, 
    :subtitle,:description, :release_date, :duration, :image, :trailer)');
    $statement->execute([
