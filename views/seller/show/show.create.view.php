                ...
                <form action="" method="post" id="create_show_form" class="mb-5">
                    <div class="flex w-full mb-4">
                        ...
                        <div class="w-full px-3 mb-3">
                            ...
                            <input type="number" name="price" id="price" min="1" class="bg-gray-50 border rounded border-gray-300 text-gray-900 sm:text-sm  focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:focus:ring-blue-500 outline-0">
                        </div>
                    </div>
                    <div class="flex w-full mb-4">
                        <div class="w-full px-3 mb-3">
