...
<div class="flex p-5 items-center justify-center">
	...
	<!-- <div class="mb-3">
		...
		<h4 class="text-white px-1 text-xl m-3">Name : <?= "<span>" . $_SESSION['username'] . "</span>"; ?></h4>
		<h4 class="text-white px-1 text-xl m-3">Email : <?= "<span>" . $_SESSION['email'] . "</span>"; ?></h4>
		<h4 class="text-white px-1 text-xl m-3">Date of birth : <?= "<span>" . $_SESSION['date'] . "</span>"; ?></h4>
		<h4 class="text-white px-1 text-xl m-3">Address : <?= "<span>" . $_SESSION['address'] . "</span>"; ?></h4>
	</div> -->
</div>
