            ...
            <div class=" w-11/12 m-auto bg-neutral-50 p-12 ">
                <div class="flex -mx-3">
                    <div class="w-full px-3 mb-3 ">
                        <label for="edit_title" class="text-black px-1 font-medium">Name</label>
                        <div class="flex">
                ...
                <div class="flex -mx-3">
                    <div class="w-full px-3 mb-3">
                        <label for="edit_hall" class="text-black px-1 font-medium">Hall</label>
                        <div class="flex">
                ...
                <div class="flex -mx-3">
                    <div class="w-full px-3 mb-3">
                        ...
                        <div class="flex">
                            <input type="text" name="edit_date" id="edit_date" placeholder="DD/MM/YY" value="<?= $show['date'] ?>" class="bg-gray-50 border rounded border-gray-300 text-gray-900 sm:text-sm  focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:focus:ring-blue-500 outline-0">
                        </div>
                    </div>
                </div>
                <div class="flex -mx-3">
