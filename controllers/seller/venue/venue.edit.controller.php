...
?>
    <form action="#" method="post" class="ml-2.5">
        ...
        <div class="modal-footer flex flex-shrink-0 flex-wrap items-center justify-end p-4 border-t border-gray-200 rounded-b-md">
            <button type="button" class="inline-block px-6 py-2.5 bg-red-600 text-white font-medium text-xs leading-tight uppercase rounded shadow-md hover:bg-red-700 transition duration-150 ease-in-out" data-bs-dismiss="modal">Close</button>
