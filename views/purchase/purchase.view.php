<div class="modal fade fixed top-0 left-0 hidden w-full h-full outline-none overflow-x-hidden overflow-y-auto" id="purchaseModal" tabindex="-1" aria-labelledby="purchaseModalLgLabel" aria-modal="true" role="dialog">
                ...
                <div class="credit-pay bg-[#06263C] p-4 w-full rounded-r-lg ">
                    ...
                    <form class="pt-4">
                        ...
                        <div class="cvc flex">
                            ...
                            <input type="text" placeholder="    CVC" class="mt-1 rounded-r-sm block w-1/4 px-3 py-2 bg-white border border-slate-300  text-sm shadow-sm placeholder-slate-400 focus:outline-none" />
                        </div>
                            <buttom type="button" class="w-full cursor-pointer uppercase hover:underline hover:bg-yellow-600 text-center text-white bg-yellow-500 mt-6  px-3 py-1.5  text-md font-bold shadow-sm rounded-sm outline-none">
                                Pay now </buttom>
                    </form>
                </div>
            </div>
